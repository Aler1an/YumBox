...
const BasketFooter = props => {
	...
	return (
		<div className={cn(flexCol, 'bg-[#222] rounded-t-[31px] px-7.25 py-5.5 pb-6.5')}>
			<div className={cn(flexBetween, 'mb-6.5 items-end')}>
			...
			<button
				...
				onClick={onCheckout}
			>
				<span className="absolute inset-0 rounded-full bg-[#fcb852]" />
				...
				<span className="absolute inset-0 rounded-full border-2 border-[#fcb852] pointer-events-none opacity-0 transition-opacity duration-500 delay-300 ease-out group-hover:opacity-100" />
